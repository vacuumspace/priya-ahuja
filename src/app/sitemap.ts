...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/fundraise/tools/fundability-score`, priority: 0.7, changeFrequency: "monthly" },
    { url: `${BASE_URL}/startup/tools/idea-score`, priority: 0.7, changeFrequency: "monthly" },
