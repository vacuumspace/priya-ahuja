...
const TEMPLATES: Template[] = [
  {
    ...
    fields: [
      { key: "email_confirmation_subject", label: "Subject line", placeholder: "Booking Confirmed: {serviceName}" },
  ...
  },
  {
    ...
    fields: [
      { key: "email_admin_subject", label: "Subject line", placeholder: "New Booking: {serviceName}" },
  ...
  },
  {
    ...
    fields: [
      { key: "email_cancellation_subject", label: "Subject line", placeholder: "Booking Cancelled: {serviceName}" },
      { key: "email_cancellation_body", label: "Body text", placeholder: "The booking for {serviceName} has been cancelled.", multiline: false },
  ...
  },
  {
    ...
    fields: [
      { key: "email_download_subject", label: "Subject line", placeholder: "Your Download: {productName}" },
...
export default function EmailTemplatesPage() {
  ...
  const loadPreview = useCallback(
    async (templateId: string, fields: Record<string, string>) => {
  ...
  // Load preview when tab or fields change (debounced)
  useEffect(() => {
