    ...
    <div className="max-w-2xl mx-auto px-6 py-16">
      ...
      <div className="font-sans text-sm text-ink/70 space-y-6 leading-relaxed">
        ...
        <section>
          ...
          <p>Consultation sessions may be rescheduled with at least 24 hours notice by emailing <a href="mailto:priyaahujaoffice@gmail.com" className="text-ink underline">priyaahujaoffice@gmail.com</a>.</p>
        </section>
        ...
        <section>
          ...
          <p>For any questions, email <a href="mailto:priyaahujaoffice@gmail.com" className="text-ink underline">priyaahujaoffice@gmail.com</a>.</p>
        </section>
      </div>
    </div>
  )
