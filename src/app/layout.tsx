...
export const metadata: Metadata = {
  ...
  description:
    "Priya Ahuja is a startup & fundraise consultant with 4+ years of startup investment and strategic consulting experience. Book a 1:1 session for fundraising readiness, investor pitch review, startup strategy, and business model feedback. Trusted by 200+ founders across India.",
  ...
  twitter: {
    ...
    description:
      "Book a 1:1 session with Priya Ahuja - startup & fundraise consultant with 4+ years of startup investment experience. Trusted by 200+ founders across India.",
      ...
      <body className="min-h-full flex flex-col">
        ...
        <Script
          ...
          __html: JSON.stringify({
            ...
            description:
              "Startup and fundraise consultant with 4+ years of startup investment and strategic consulting experience. Helping early-stage founders with fundraising readiness, investor pitch review, and startup strategy. 200+ founders advised across India.",
            sameAs: [
