...
import type { StartupIdea } from "@/lib/startup-ideas-data"
...
export default function IdeaArticle({ idea, backHref, backLabel, crumbLeft }: Props) {
  return (
    <div className="min-h-screen bg-cream">
      ...
      <article className="px-4 md:px-10 pt-10 pb-16 max-w-2xl">
        <Link href={backHref} className="inline-flex items-center gap-1.5 text-xs font-sans text-ink/40 hover:text-ink transition-colors mb-8">
