...
export const PILLARS: Pillar[] = [
  ...
  { index: 8, title: "team & execution",          maxPoints: 8,  questionIds: [47, 48, 49, 50] },
]
...
export const QUESTIONS: Question[] = [
  ...
  {
    id: 1,
    text: "can you articulate the problem in one sentence that makes an investor say 'the market clearly needs this'?",
    pillarIndex: 0,
    options: [
      { label: "vague idea",               sublabel: "i know something is wrong but can't pitch it yet",     points: 0 },
      { label: "clear pain point",          sublabel: "i can describe who has it and what it costs them",    points: 1 },
      { label: "urgent pain with evidence", sublabel: "data, interviews, or press validate the scale of pain", points: 2 },
    ],
    recommendationByOption: [
      "Investors decide in the first 90 seconds. If you can't write the problem in one sentence that provokes a reaction, you'll lose them in slide 2. Run 10 discovery interviews, find the sharpest version of the pain, and make that your opening line.",
      "A clear pain point is a start. Now add the investor lens: what's the scale of this pain? How many people have it? What are they currently paying (in time or money) to deal with it? Those numbers belong in your pitch.",
      null,
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { label: "free pilot",          sublabel: "someone is testing it, unpaid or discounted",  points: 1 },
  ...
  },
  {
    ...
    options: [
      ...
      { label: "some channel thinking",     sublabel: "have ideas about channels but not validated",         points: 1 },
      { label: "tested and documented",     sublabel: "one channel is working and i understand why it works", points: 2 },
    ],
    recommendationByOption: [
      "'We'll figure out distribution later' is what kills most funded startups. Investors know distribution is harder than product. Write your distribution thesis now: channel, message, unit economics. It belongs in slide 8.",
      "Channel ideas without proof are assumptions. Run one small experiment: ₹5,000 in paid, or 50 cold emails, or one partnership. What did it cost to get one interested lead? That number changes your whole narrative.",
      null,
    ],
  },
  {
  ...
  {
    id: 34,
    text: "can you show an investor a clear before/after: how your product or positioning changed based on real user data?",
    pillarIndex: 5,
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      { label: "positive but vague", sublabel: "users seem happy but i haven't measured it formally",  points: 1 },
      { label: "strong signal",      sublabel: "NPS above 40, or organic referrals happening unprompted", points: 2 },
    ],
    recommendationByOption: [
  ...
  // ─── Segment 6: Business Model ─────────────────────────────────────────────
  {
    ...
    options: [
      ...
      { label: "model exists, untested", sublabel: "have a pricing idea but nobody has paid yet",                points: 1 },
      { label: "tested with real money", sublabel: "customers have paid and the model holds at small scale",     points: 2 },
    ],
    recommendationByOption: [
      "No revenue model is an automatic pass for most investors. Write it out: 'We charge [who] [how much] per [unit/month/transaction] because [the value they get].' That one sentence is slide 6 of your deck.",
      "An untested model means every number in your financial projections is fiction. Run a pricing test this month: charge someone, anything, and see if they pay. Change the model based on what they say, not what you assume.",
      null,
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { label: "mixed",               sublabel: "some recurring revenue but most is still transactional", points: 1 },
  ...
  },
  {
    ...
    options: [
      ...
      { label: "aware but no clear plan",   sublabel: "know the risk, haven't structured the mitigation",         points: 1 },
